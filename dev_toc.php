	...
	<body>
		...
		<div class="container">
			<ul class="toc">
				<a href="#">
				<li>
					Millenium Park<small> - (63 images)</small>
				</li></a>
				<li>
					<a href="#">Mom's Deck</a><small> - (33 images)</small>
				</li>
				<li>
					<a href="#">AON Deer</a><small> - (6 images)</small>
				</li>
				<li>
					Marilyn Monroe statue / Millenium Park - (44 images)
				</li>
				<li>
					6-9-2012 - (120 images)
				</li>
				<li>
					Burning Man 2012 - (248 images)
				</li>
				<li>
					Buckingham Fountain - (36 images)
				</li>
				<li>
					Garfield Park Conservatory - (50 images)
				</li>
				<li>
					River North - (20 images)
				</li>
				<li>
					Christmas 2011 - (15 images)
				</li>
			</ul>
